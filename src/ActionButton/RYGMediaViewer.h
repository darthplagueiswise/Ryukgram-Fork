// RYGMediaViewer — full-screen media viewer. Supports single items and carousels.
...
@interface RYGMediaViewerItem : NSObject
...
@property (nonatomic, strong, nullable) RYGGallerySaveMetadata *metadata;
...
@interface RYGMediaViewer : NSObject
