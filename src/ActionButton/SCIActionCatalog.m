...
NSString *const SCIAID_SavePicturePhotos   = @"save_picture_photos";
...
+ (NSArray<SCIActionDescriptor *> *)descriptorsForSource:(SCIActionSource)source {
    if (!gSCIActionCatalogCache) {
        ...
        NSArray *feed = @[
            ...
            d(SCIAID_DownloadWithMusic,   SCILocalized(@"Save with music"),        @"music.note",                         YES),
         dOff(SCIAID_DownloadWithMusicGallery, SCILocalized(@"Gallery with music"),@"music.note.list",                    YES),
        ...
        NSArray *profile = @[
            ...
            d(SCIAID_SavePicturePhotos,     SCILocalized(@"Save to Photos"),         @"square.and.arrow.down",              YES),
        ...
        case SCIActionSourceFeed:
            return @[
                ...
                section(@"download",
                        ...
                        @[SCIAID_DownloadShare, SCIAID_DownloadSave, SCIAID_DownloadWithMusic, SCIAID_DownloadGallery, SCIAID_DownloadWithMusicGallery]),
                section(@"bulk",
        ...
        case SCIActionSourceProfile:
            return @[
                ...
                section(@"navigation",
                        ...
                        @[SCIAID_ViewPicture, SCIAID_SharePicture, SCIAID_SavePicturePhotos, SCIAID_SavePictureGallery, SCIAID_ProfileSettings]),
                section(@"info",
