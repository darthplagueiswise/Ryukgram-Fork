...
- (void)rebuildSections {
    ...
    RYGSetting *prism = [RYGSetting navigationCellWithTitle:@"Prism UI" subtitle:@"Live IGDS / BSLDS BOOL customization surface" icon:[RYGSymbol symbolWithName:@"layout"] viewController:[[RYGDeveloperTopicViewController alloc] initWithSurface:RYGDeveloperRuntimeSurfacePrism]];
