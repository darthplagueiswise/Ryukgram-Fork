...
- (void)configureWithTheme:(id)theme threadAppearance:(NSInteger)appearance themeId:(id)themeId traitCollection:(id)trait {
	%orig;
	RYGProbeOnce(@"chatbg.configure.legacy", @"configureWithTheme:…traitCollection: fired (pre-444)");
	[(UIView *)self ryg_applyCustomBackground];
}

// IG 444 inserted shouldBlurBackgroundImage: ahead of traitCollection:.
- (void)configureWithTheme:(id)theme threadAppearance:(NSInteger)appearance themeId:(id)themeId shouldBlurBackgroundImage:(BOOL)shouldBlur traitCollection:(id)trait {
	%orig;
	RYGProbeOnce(@"chatbg.configure.444", @"configureWithTheme:…shouldBlurBackgroundImage:… fired");
	[(UIView *)self ryg_applyCustomBackground];
}
