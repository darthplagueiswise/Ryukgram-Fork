#import "RYGDeletedMessagesChipBar.h"
#import "../../Gallery/RYGGalleryChip.h"

@interface RYGDeletedMessagesChipBar ()
@property (nonatomic, strong) UIScrollView *scroll;
@property (nonatomic, strong) UIStackView *stack;
@property (nonatomic, strong) NSArray<RYGGalleryChip *> *chips;
@end

@implementation RYGDeletedMessagesChipBar
...
- (void)setItems:(NSArray<NSString *> *)titles symbols:(NSArray<NSString *> *)symbols {
	...
	for (NSUInteger i = 0; i < titles.count; i++) {
		...
		RYGGalleryChip *chip = [RYGGalleryChip chipWithTitle:titles[i] symbol:symbol];
...
- (void)chipTapped:(RYGGalleryChip *)chip {
