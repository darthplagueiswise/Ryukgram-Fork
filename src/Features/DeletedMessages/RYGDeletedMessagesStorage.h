...
extern NSNotificationName const RYGDeletedMessagesDidChangeNotification;
...
@interface RYGDeletedMessagesStorage : NSObject
...
+ (NSArray<RYGDeletedMessage *> *)messagesForSenderPK:(NSString *)senderPK
...
+ (NSArray<RYGDeletedMessage *> *)messagesForThreadId:(NSString *)threadId
                                              ownerPK:(NSString *)ownerPK;
...
+ (BOOL)updateMessageWithId:(NSString *)messageId
                    ownerPK:(NSString *)ownerPK
                    mutator:(BOOL (^)(RYGDeletedMessage *m))mutator;
...
// RYGDeletedMessageGroup.identifier: threadId, else "s:<senderPk>".
