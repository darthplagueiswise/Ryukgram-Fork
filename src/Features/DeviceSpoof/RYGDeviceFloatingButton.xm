...
static void RYGShowDeviceMenu(UIView *sourceView) {
    ...
    UIAlertController *a = [UIAlertController
        ...
        message:[NSString stringWithFormat:@"%@ · %@\n%@",
                 ...
                 mid ?: RYGLocalized(@"No machine ID yet")]
        preferredStyle:UIAlertControllerStyleActionSheet];

    [a addAction:[UIAlertAction actionWithTitle:RYGLocalized(@"Mask everything & relaunch")
        style:UIAlertActionStyleDestructive handler:^(__unused UIAlertAction *x) {
            [RYGDeviceMenu presentMaskEverythingConfirmFrom:RYGTopMostVC()];
        }]];
    ...
    [a addAction:[UIAlertAction actionWithTitle:RYGLocalized(@"Enter machine ID manually…")
        style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *x) {
            [RYGDeviceMenu presentCustomMachineIDFrom:RYGTopMostVC() onChange:onChange];
        }]];
    [a addAction:[UIAlertAction actionWithTitle:RYGLocalized(@"Copy current ID")
        style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *x) {
            [RYGDeviceMenu copyCurrentID];
        }]];
    [a addAction:[UIAlertAction actionWithTitle:RYGLocalized(@"Copy machine ID")
        style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *x) {
    ...
    [a addAction:[UIAlertAction actionWithTitle:[NSString stringWithFormat:
        ...
        style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *x) {
            ...
            [RYGUtils showToastForDuration:2.2
                ...
                subtitle:RYGLocalized(@"Relaunch to apply")];
        }]];
    if (on)
