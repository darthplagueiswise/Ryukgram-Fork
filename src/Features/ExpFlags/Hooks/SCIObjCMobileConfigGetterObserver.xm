...
static BOOL Ptr(const char*t){return t&&(t[0]=='@'||t[0]=='#'||t[0]=='^'||t[0]==':'||t[0]=='*');}
static BOOL LooksBoolU64Opt(Class c,SEL s){Method m=class_getInstanceMethod(c,s);if(!m||method_getNumberOfArguments(m)!=4)return NO;char r[64]={0},a2[64]={0},a3[64]={0};method_getReturnType(m,r,sizeof(r));method_getArgumentType(m,2,a2,sizeof(a2));method_getArgumentType(m,3,a3,sizeof(a3));NSUInteger z2=0,z3=0;return BoolRet(r)&&TSize(a2,&z2)&&TSize(a3,&z3)&&I64(a2)&&z2==8&&Ptr(a3)&&z3==sizeof(void*);}
