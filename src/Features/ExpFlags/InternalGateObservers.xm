...
static BOOL rgHasManualOverrides(void) {
    return [SCIExpFlags allOverriddenInternalUseSpecifiers].count > 0;
}

static BOOL rgShouldInstall(void) {
    return rgObserverEnabled() || rgForceEnabled() || rgHasManualOverrides();
}
...
static void rgRecordGate(NSString *functionName,
    ...
    SCIExpFlagOverride manual = [SCIExpFlags internalUseOverrideForSpecifier:specifier];
    BOOL hasManual = manual != SCIExpFlagOverrideOff;

    if (!rgObserverEnabled() && !forced && !hasManual) return;

    NSString *specifierName = label ?: @"unknown";
    if (hasManual && specifierName.length) {
        specifierName = [specifierName stringByAppendingString:(manual == SCIExpFlagOverrideTrue ? @" · manual ON" : @" · manual OFF")];
    }
    ...
    if ([SCIUtils getBoolPref:@"igt_internaluse_observer"]) {
        NSLog(@"[RyukGram][GateForce][%@] %@ spec=0x%016llx default=%d original=%d returned=%d forced=%d manual=%ld caller=%p",
              functionName ?: @"Gate",
              specifierName,
              specifier,
              defaultValue,
...
static uintptr_t hook_MCIMobileConfigGetBoolean(uintptr_t a0,
                                                ...
                                                uintptr_t a6,
                                                uintptr_t a7) {
    uintptr_t original = orig_MCIMobileConfigGetBoolean ? orig_MCIMobileConfigGetBoolean(a0, a1, a2, a3, a4, a5, a6, a7) : 0;
    uint64_t specifier = rgPickSpecifier((uint64_t)a2, (uint64_t)a0, (uint64_t)a1, (uint64_t)a2, (uint64_t)a3);
    return rgBoolReturn(original, @"MCIMobileConfigGetBoolean", rgArgLabel(@"MCI mobileconfig", @"preferred=x2"), specifier, (BOOL)(a2 & 1), __builtin_return_address(0));
}
...
static uintptr_t hook_MCIExperimentCacheGetMobileConfigBoolean(uintptr_t a0,
                                                               ...
                                                               uintptr_t a6,
                                                               uintptr_t a7) {
    uintptr_t original = orig_MCIExperimentCacheGetMobileConfigBoolean ? orig_MCIExperimentCacheGetMobileConfigBoolean(a0, a1, a2, a3, a4, a5, a6, a7) : 0;
    uint64_t specifier = rgPickSpecifier((uint64_t)a2, (uint64_t)a0, (uint64_t)a1, (uint64_t)a2, (uint64_t)a3);
    return rgBoolReturn(original, @"MCIExperimentCacheGetMobileConfigBoolean", rgArgLabel(@"MCI experiment cache", @"preferred=x2"), specifier, (BOOL)(a2 & 1), __builtin_return_address(0));
}
...
static uintptr_t hook_MCIExtensionExperimentCacheGetMobileConfigBoolean(uintptr_t a0,
                                                                        ...
                                                                        uintptr_t a6,
                                                                        uintptr_t a7) {
    uintptr_t original = orig_MCIExtensionExperimentCacheGetMobileConfigBoolean ? orig_MCIExtensionExperimentCacheGetMobileConfigBoolean(a0, a1, a2, a3, a4, a5, a6, a7) : 0;
    uint64_t specifier = rgPickSpecifier((uint64_t)a2, (uint64_t)a0, (uint64_t)a1, (uint64_t)a2, (uint64_t)a3);
    return rgBoolReturn(original, @"MCIExtensionExperimentCacheGetMobileConfigBoolean", rgArgLabel(@"MCI extension cache", @"preferred=x2"), specifier, (BOOL)(a2 & 1), __builtin_return_address(0));
}
...
static uintptr_t hook_METAExtensionsExperimentGetBoolean(uintptr_t a0,
                                                         ...
                                                         uintptr_t a6,
                                                         uintptr_t a7) {
    uintptr_t original = orig_METAExtensionsExperimentGetBoolean ? orig_METAExtensionsExperimentGetBoolean(a0, a1, a2, a3, a4, a5, a6, a7) : 0;
    uint64_t specifier = rgPickSpecifier((uint64_t)a1, (uint64_t)a0, (uint64_t)a1, (uint64_t)a2, (uint64_t)a3);
    return rgBoolReturn(original, @"METAExtensionsExperimentGetBoolean", rgArgLabel(@"META extensions exposure", @"preferred=x1"), specifier, (BOOL)(a2 & 1), __builtin_return_address(0));
}
...
static uintptr_t hook_METAExtensionsExperimentGetBooleanWithoutExposure(uintptr_t a0,
                                                                        ...
                                                                        uintptr_t a6,
                                                                        uintptr_t a7) {
    uintptr_t original = orig_METAExtensionsExperimentGetBooleanWithoutExposure ? orig_METAExtensionsExperimentGetBooleanWithoutExposure(a0, a1, a2, a3, a4, a5, a6, a7) : 0;
    uint64_t specifier = rgPickSpecifier((uint64_t)a1, (uint64_t)a0, (uint64_t)a1, (uint64_t)a2, (uint64_t)a3);
    return rgBoolReturn(original, @"METAExtensionsExperimentGetBooleanWithoutExposure", rgArgLabel(@"META extensions no-exposure", @"preferred=x1"), specifier, (BOOL)(a2 & 1), __builtin_return_address(0));
}
...
static uintptr_t hook_MSGCSessionedMobileConfigGetBoolean(uintptr_t a0,
                                                          ...
                                                          uintptr_t a6,
                                                          uintptr_t a7) {
    uintptr_t original = orig_MSGCSessionedMobileConfigGetBoolean ? orig_MSGCSessionedMobileConfigGetBoolean(a0, a1, a2, a3, a4, a5, a6, a7) : 0;
    uint64_t specifier = rgPickSpecifier((uint64_t)a1, (uint64_t)a0, (uint64_t)a1, (uint64_t)a2, (uint64_t)a3);
    return rgBoolReturn(original, @"MSGCSessionedMobileConfigGetBoolean", rgArgLabel(@"MSGC sessioned mobileconfig", @"preferred=x1"), specifier, (BOOL)(a2 & 1), __builtin_return_address(0));
}
...
static uintptr_t hook_EasyGatingPlatformGetBoolean(uintptr_t a0,
                                                   ...
                                                   uintptr_t a6,
                                                   uintptr_t a7) {
    uintptr_t original = orig_EasyGatingPlatformGetBoolean ? orig_EasyGatingPlatformGetBoolean(a0, a1, a2, a3, a4, a5, a6, a7) : 0;
    uint64_t specifier = rgPickSpecifier((uint64_t)a1, (uint64_t)a0, (uint64_t)a1, (uint64_t)a2, (uint64_t)a3);
    return rgBoolReturn(original, @"EasyGatingPlatformGetBoolean", rgArgLabel(@"EasyGating platform", @"preferred=x1"), specifier, (BOOL)(a2 & 1), __builtin_return_address(0));
}
...
static uintptr_t hook_EasyGatingGetBoolean_Internal_DoNotUseOrMock(uintptr_t gate,
                                                                   ...
                                                                   uintptr_t a6,
                                                                   uintptr_t a7) {
    uintptr_t original = orig_EasyGatingGetBoolean_Internal_DoNotUseOrMock ? orig_EasyGatingGetBoolean_Internal_DoNotUseOrMock(gate, a1, defaultValue, a3, a4, a5, a6, a7) : 0;
    return rgBoolReturn(original, @"EasyGatingGetBoolean_Internal_DoNotUseOrMock", rgArgLabel(@"EasyGating raw gate", @"preferred=x0"), (uint64_t)gate, (BOOL)(defaultValue & 1), __builtin_return_address(0));
}
...
static uintptr_t hook_EasyGatingGetBooleanUsingAuthDataContext_Internal_DoNotUseOrMock(uintptr_t a0,
                                                                                       ...
                                                                                       uintptr_t a6,
                                                                                       uintptr_t a7) {
    uintptr_t original = orig_EasyGatingGetBooleanUsingAuthDataContext_Internal_DoNotUseOrMock ? orig_EasyGatingGetBooleanUsingAuthDataContext_Internal_DoNotUseOrMock(a0, gate, defaultValue, authCtx, a4, a5, a6, a7) : 0;
    return rgBoolReturn(original, @"EasyGatingGetBooleanUsingAuthDataContext_Internal_DoNotUseOrMock", rgArgLabel(@"EasyGating auth-data raw gate", @"preferred=x1"), (uint64_t)gate, (BOOL)(defaultValue & 1), __builtin_return_address(0));
}
...
static int hook_MCQEasyGatingGetBooleanInternalDoNotUseOrMock(uintptr_t a0,
    ...
    int status = orig_MCQEasyGatingGetBooleanInternalDoNotUseOrMock ? orig_MCQEasyGatingGetBooleanInternalDoNotUseOrMock(a0, gate, a2, defaultValue, outValue) : 0;
...
static uintptr_t hook_MCDDasmNativeGetMobileConfigBooleanV2DvmAdapter(uintptr_t a0,
                                                                      ...
                                                                      uintptr_t a6,
                                                                      uintptr_t a7) {
    uintptr_t original = orig_MCDDasmNativeGetMobileConfigBooleanV2DvmAdapter ? orig_MCDDasmNativeGetMobileConfigBooleanV2DvmAdapter(a0, a1, a2, a3, a4, a5, a6, a7) : 0;
...
%ctor {
    ...
    NSLog(@"[RyukGram][GateForce] installed rc=%d force=%d observer=%d manual=%d mci=%p mciCache=%p mciExt=%p meta=%p metaNoExposure=%p msgc=%p egPlatform=%p egInternal=%p egAuth=%p mcq=%p dvm=%p",
          rc,
          rgForceEnabled(),
          rgObserverEnabled(),
          rgHasManualOverrides(),
