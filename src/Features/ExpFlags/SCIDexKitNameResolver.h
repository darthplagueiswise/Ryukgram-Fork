...
+ (SCIDexKitResolvedName *)resolveBrokerID:(nullable NSString *)brokerID value:(uint64_t)value;
+ (NSDictionary *)resolvedDictionaryForBrokerID:(nullable NSString *)brokerID value:(uint64_t)value;
