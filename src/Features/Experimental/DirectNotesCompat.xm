...
static inline BOOL prefFriendMap(void) { return [RYGUtils getBoolPref:@"igt_directnotes_friendmap"]; }
static inline BOOL prefAudio(void)     { return [RYGUtils getBoolPref:@"igt_directnotes_audio_reply"]; }
static inline BOOL prefAvatar(void)    { return [RYGUtils getBoolPref:@"igt_directnotes_avatar_reply"]; }
static inline BOOL prefGifs(void)      { return [RYGUtils getBoolPref:@"igt_directnotes_gifs_reply"]; }
static inline BOOL prefPhoto(void)     { return [RYGUtils getBoolPref:@"igt_directnotes_photo_reply"]; }
