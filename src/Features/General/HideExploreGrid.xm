...
static BOOL sciHideGrid(void)   { return [SCIUtils getBoolPref:@"hide_explore_grid"] || [SCIUtils getBoolPref:@"messages_only"]; }
static BOOL sciHideSearch(void) { return [SCIUtils getBoolPref:@"hide_trending_searches"] || [SCIUtils getBoolPref:@"messages_only"]; }
