...
FOUNDATION_EXPORT NSNotificationName const RYGReadReceiptsDidChangeNotification;

@interface RYGReadReceiptStorage : NSObject
...
+ (void)deleteReceiptWithMessageId:(NSString *)messageId readerPk:(NSString *)readerPk threadId:(nullable NSString *)threadId ownerPK:(NSString *)ownerPK;
