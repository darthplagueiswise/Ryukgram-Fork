...
- (UIMenu *)dotsMenu {
	...
	UIAction *stats = [UIAction actionWithTitle:RYGLocalized(@"Story stats") image:[RYGSymbol symbolWithIGName:@"ig_icon_insights_outline_24" fallback:@"chart.bar.xaxis"].image identifier:nil handler:^(UIAction *ac) { [RYGStoriesArchiveStatsViewController showFrom:w]; }];
	...
	UIMenu *tools = [UIMenu menuWithTitle:@"" image:nil identifier:nil options:UIMenuOptionsDisplayInline children:@[stats, select, settings]];
