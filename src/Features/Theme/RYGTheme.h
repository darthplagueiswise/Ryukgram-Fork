...
typedef NS_ENUM(NSInteger, RYGThemeMode) {
	RYGThemeModeOff = 0,
	RYGThemeModeLight,
	RYGThemeModeDark,
	RYGThemeModeOLED,
...
extern NSString *const RYGThemePrefMode;     // string: off/light/dark/oled
extern NSString *const RYGThemePrefForce;    // bool
extern NSString *const RYGThemePrefOLEDChat; // bool
extern NSString *const RYGThemePrefKeyboard; // string: off/dark/oled

@interface RYGTheme : NSObject
...
// YES when the responder chain contains a RyukGram (RYG-prefixed) object.
