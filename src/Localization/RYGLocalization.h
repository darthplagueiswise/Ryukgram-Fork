...
extern NSString *const RYGLanguagePrefKey;
...
NSBundle * _Nullable RYGLocalizationBundle(void);
...
NSString *RYGLocalizedString(NSString *key, NSString * _Nullable fallback);
...
#define RYGLocalized(key) RYGLocalizedString((key), (key))
