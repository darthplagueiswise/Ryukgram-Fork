// Passcode entry / verification VC. Wraps RYGLockPasscodeView, runs verification
// against RYGLockManager, auto-fires biometric on appear when enabled, and shakes
...
@interface RYGLockPasscodeViewController : UIViewController
