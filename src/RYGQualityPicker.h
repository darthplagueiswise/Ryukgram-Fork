// RYGQualityPicker — quality selection bottom sheet for HD downloads.

#import <UIKit/UIKit.h>
#import "RYGDashParser.h"
#import "Downloader/Download.h"

@interface RYGQualityPicker : NSObject
...
+ (BOOL)pickQualityForMedia:(id)media
                   fromView:(UIView *)sourceView
                     ...
                     picked:(void(^)(RYGDashRepresentation *video, RYGDashRepresentation *audio))picked
