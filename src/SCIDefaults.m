...
NSDictionary *SCIDefaultsDictionary(void) {
	return @{
		...
		// Liquid Glass — individual feature toggles (master keys removed).
		@"lg_native_enabled": @(NO),
		@"lg_inapp_notif": @(NO),
		@"lg_toast": @(NO),
		@"lg_ease_in_out_blur": @(NO),
		@"lg_swizzle_buttons": @(NO),
		@"lg_nav_enabled": @(NO),
		@"lg_home_feed_header": @(NO),
		@"lg_glass_rendering": @(NO),
		@"lg_glass_background_steps": @(NO),
		@"lg_legibility_blur": @(NO),
		@"lg_profile_navbar_match": @(NO),
		@"lg_profile_segmented_tabs_glass": @(NO),
		@"lg_floating_tab_bar": @(NO),
		@"lg_tab_bar_dynamic_sizing": @(NO),
		@"lg_tab_bar_enhanced_sizing": @(NO),
		@"lg_tab_bar_homecoming_floating": @(NO),
		...
		@"sci_force_mc_sessionless_internal_use_boolean": @(NO),
