...
NSDictionary *SCIDefaultsDictionary(void) {
	return @{
		...
		@"sci_igplus_story_view_notify": @(NO),
		@"sci_igplus_links_in_media": @(NO),
		@"sci_igplus_ads_incentive_feed": @(NO),
		@"sci_igplus_ads_incentive_story": @(NO),
		@"sci_igplus_ads_incentive_story_captain": @(NO),
		@"sci_igplus_ads_incentive_reels": @(NO),
		@"sci_igplus_ads_incentive_promo_sheet": @(NO),
		@"sci_igplus_free_trial_offer": @(NO),
