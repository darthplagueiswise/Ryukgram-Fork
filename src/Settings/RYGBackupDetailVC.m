...
@interface RYGBackupDetailVC () <UITableViewDataSource, UITableViewDelegate, UISearchResultsUpdating, UISearchControllerDelegate>
...
@implementation RYGBackupDetailVC
...
- (void)viewDidLoad {
	...
	self.searchController.searchBar.placeholder = RYGLocalized(@"Search");
