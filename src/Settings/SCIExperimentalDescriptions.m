...
static NSDictionary<NSString *, NSString *> *SCIExperimentalDescriptionMap(void) {
    ...
    dispatch_once(&onceToken, ^{
        map = @{
            ...
            @"igt_mutual_interest": @"Mutual Interest feature in Direct Messages.",
            @"igt_icebreaker": @"Icebreaker feature for mutually liked reels.",
            @"igt_story_grid": @"Story grid view in profile and tray.",
            @"igt_stories_tray_decoupling": @"Decouple Stories tray from feed fetch.",
            @"igt_dm_inline_like": @"Inline like button in DM message menu.",
            @"igt_multiple_notes": @"Allow posting multiple Notes simultaneously.",
            @"igt_dn_first_badge": @"First Note badge indicator.",
            @"igt_screenshot_block": @"Screenshot blocking experiments.",
            @"igt_employee_master": @"Master switch for all employee/internal gates.",
            ...
            @"igt_internal_apps_spoof": @"Forces internal apps-installed gate to true.",
