...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:SCIGlassParamCell.class forCellReuseIdentifier:@"info"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SCIGlassParamCell *cell = [tableView dequeueReusableCellWithIdentifier:@"info" forIndexPath:indexPath];
