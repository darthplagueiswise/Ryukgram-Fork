...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *kindLabel = [self.broker.kindLabel isKindOfClass:NSString.class] ? self.broker.kindLabel : @"";
    [detailParts addObject:[NSString stringWithFormat:@"%@ · system %@ · %@", kindLabel, [SCIMobileConfigBrokerStore systemLabelForOverrideKey:key], [SCIMobileConfigBrokerStore overrideLabelForOverrideKey:key]]];
