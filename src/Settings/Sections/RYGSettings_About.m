	...
	return @[
		...
		@{
			...
			@"rows": @[
				...
				[RYGSetting linkCellWithTitle:@"asdfzxcvbn" subtitle:RYGLocalized(@"zxPluginsInject sideload compatibility shim") icon:nil url:@"https://github.com/asdfzxcvbn/zxPluginsInject"],
			]
		},
		@{
			...
			@"rows": @[
				...
				[RYGSetting linkCellWithTitle:@"hooray804" subtitle:RYGLocalized(@"Korean translation") icon:nil url:@"https://github.com/hooray804"],
