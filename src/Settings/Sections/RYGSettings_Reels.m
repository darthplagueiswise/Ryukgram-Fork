...
#import "../../Features/Reels/RYGReelsHold.h"
...
static RYGSetting *rygReelsHoldCell(void) {
	NSString *subtitle = [RYGReelsHold mobileConfigOverridesLongPress]
		? RYGLocalized(@"Ignored while MobileConfig overrides it")
		: RYGLocalized(@"Set what holding a reel does");

	return [RYGSetting menuCellWithTitle:RYGLocalized(@"Hold Controls")
							   subtitle:subtitle
								   menu:[RYGTweakSettings menus][@"reels_long_press"]];
}
	...
	return [RYGSetting navigationCellWithTitle:RYGLocalized(@"Reels")
										...
										@{
											...
											@"rows": @[
												...
												rygReelsHoldCell(),
												[RYGSetting navigationCellWithTitle:RYGLocalized(@"Playback") subtitle:RYGLocalized(@"Speed, seek, pause and auto-scroll controls") icon:nil navSections:@[@{
													...
													@"rows": @[
														...
														[RYGSetting switchCellWithTitle:RYGLocalized(@"Pause control") subtitle:@"" defaultsKey:@"reels_playback_pause"],
