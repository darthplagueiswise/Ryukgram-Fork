...
+ (SCISetting *)advancedNavCell {
	return [SCISetting navigationCellWithTitle:SCILocalized(@"Advanced")
										...
										@{
											...
											@"footer": SCILocalized(@"These hook real BOOL getters and imported C gates confirmed in Instagram metadata. Restart Instagram after changing them. Feed/stories rows can still be server-gated by GraphQL model data."),
												@"rows": @[
												...
												[SCISetting switchCellWithTitle:SCILocalized(@"Force all MobileConfig BOOL gates") subtitle:SCILocalized(@"Master switch for the four bool-returning MobileConfig C gates below") defaultsKey:@"sci_force_mc_internal_use_all" requiresRestart:YES],
												...
												[SCISetting switchCellWithTitle:SCILocalized(@"MobileConfig SetConfigOverrides") subtitle:SCILocalized(@"Wrap IGMobileConfigSetConfigOverrides and apply custom overrides when present") defaultsKey:@"sci_force_mobileconfig_overrides" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"MobileConfig TryUpdateConfigs") subtitle:SCILocalized(@"Wrap IGMobileConfigTryUpdateConfigsWithCompletion and call original") defaultsKey:@"sci_force_mobileconfig_try_update" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"MobileConfig ForceUpdateConfigs") subtitle:SCILocalized(@"Wrap IGMobileConfigForceUpdateConfigs and call original") defaultsKey:@"sci_force_mobileconfig_force_update" requiresRestart:YES],
