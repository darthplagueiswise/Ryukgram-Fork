	...
	return [SCISetting navigationCellWithTitle:SCILocalized(@"Advanced")
										...
										@{
											...
											@"footer": SCILocalized(@"These hook real BOOL getters and safe imported C BOOL gates confirmed in Instagram metadata. Restart Instagram after changing them. Action/update functions are intentionally not fishhooked because they crash at launch."),
												...
												[SCISetting switchCellWithTitle:SCILocalized(@"IGFacebookUserInfo.isEmployee") subtitle:@"" defaultsKey:@"sci_force_ig_is_employee" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Persist employee defaults") subtitle:@"" defaultsKey:@"sci_force_employee_defaults_persist" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Featured internal badge") subtitle:@"" defaultsKey:@"sci_force_ig_featured_internal_badge" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Inbox internal badge") subtitle:@"" defaultsKey:@"sci_force_ig_inbox_internal_badge" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Creation internal label") subtitle:@"" defaultsKey:@"sci_force_ig_creation_internal_label" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Launch debug info") subtitle:@"" defaultsKey:@"sci_force_ig_launch_debug_info" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Launch debug info V2") subtitle:@"" defaultsKey:@"sci_force_ig_launch_debug_info_v2" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Story debug underlay") subtitle:@"" defaultsKey:@"sci_force_ig_story_debug_underlay" requiresRestart:YES],
											]
										},
										@{
