...
+ (SCISetting *)profileNavCell {
	return [SCISetting navigationCellWithTitle:SCILocalized(@"Profile")
										...
										@{
											...
											@"rows": @[
												[SCISetting switchCellWithTitle:SCILocalized(@"Show full follower count") subtitle:SCILocalized(@"Show the exact number instead of a shortened one") defaultsKey:@"full_followers_count"],
												[SCISetting switchCellWithTitle:SCILocalized(@"Show full post count") subtitle:SCILocalized(@"Show the exact number instead of a shortened one") defaultsKey:@"full_posts_count"],
											]
										},
										@{
										...
										@{
											...
											@"rows": @[
												[SCISetting switchCellWithTitle:SCILocalized(@"Override view count") subtitle:SCILocalized(@"Show the exact number instead of a shortened one") defaultsKey:@"reel_card_full_views" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Show like count") subtitle:SCILocalized(@"Adds the like count to each card") defaultsKey:@"reel_card_show_likes" requiresRestart:YES],
												[SCISetting switchCellWithTitle:SCILocalized(@"Show upload date") subtitle:SCILocalized(@"Adds the upload date to each card") defaultsKey:@"reel_card_show_date" requiresRestart:YES],
										...
										@{
											...
											@"rows": @[
												...
												[SCISetting switchCellWithTitle:SCILocalized(@"Fake follower count") subtitle:SCILocalized(@"Show the custom number set below") defaultsKey:@"fake_follower_count" requiresRestart:YES],
												...
												[SCISetting switchCellWithTitle:SCILocalized(@"Fake following count") subtitle:SCILocalized(@"Show the custom number set below") defaultsKey:@"fake_following_count" requiresRestart:YES],
												...
												[SCISetting switchCellWithTitle:SCILocalized(@"Fake post count") subtitle:SCILocalized(@"Show the custom number set below") defaultsKey:@"fake_post_count" requiresRestart:YES],
