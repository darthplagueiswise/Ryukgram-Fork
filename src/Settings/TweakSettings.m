                ...
                [SCISetting navigationCellWithTitle:SCILocalized(@"General")
                                        ...
                                        @{
                                            ...
                                            @"rows": @[
                                                ...
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable Homecoming UI") subtitle:SCILocalized(@"Forces the Homecoming navigation style") defaultsKey:@"igt_homecoming" requiresRestart:YES],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable Prism design system") subtitle:SCILocalized(@"Forces Prism design system surfaces where available") defaultsKey:@"igt_prism" requiresRestart:YES],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable dynamic tab layout") subtitle:SCILocalized(@"Forces dynamic tab story grid and fullscreen switcher") defaultsKey:@"igt_dynamic_tab"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable Reels first/second experiment") subtitle:SCILocalized(@"Forces the Reels ordering experiment used by Instagram") defaultsKey:@"igt_reels_first"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable Friends Feed") subtitle:SCILocalized(@"Forces older-posts Friends Feed experiment") defaultsKey:@"igt_friends_feed"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable audio ramping on swipe") subtitle:SCILocalized(@"Turns on audio ramping while swiping between tabs") defaultsKey:@"igt_audio_ramping"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable feed culling") subtitle:SCILocalized(@"Forces feed culling on status bar experiment") defaultsKey:@"igt_feed_culling"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable feed dedup") subtitle:SCILocalized(@"Forces feed dedup from reels optimization") defaultsKey:@"igt_feed_dedup"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable Pull to Carrera") subtitle:SCILocalized(@"Turns on the pull-to-Carrera navigation experiment") defaultsKey:@"igt_pull_to_carrera"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Force employee mode") subtitle:SCILocalized(@"Makes current IGUser report employee status") defaultsKey:@"igt_employee"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Force internal mode") subtitle:SCILocalized(@"Makes current IGUser report internal status") defaultsKey:@"igt_internal"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Enable screenshot blocking") subtitle:SCILocalized(@"Uses Instagram's screenshot blocking behavior where supported") defaultsKey:@"igt_screenshot_block"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Direct Notes: Friend Map") subtitle:SCILocalized(@"Forces the Friend Map flag inside Direct Notes") defaultsKey:@"igt_directnotes_friendmap"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Direct Notes: Audio reply") subtitle:SCILocalized(@"Forces the audio reply type for Direct Notes") defaultsKey:@"igt_directnotes_audio_reply"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Direct Notes: Avatar reply") subtitle:SCILocalized(@"Forces the avatar reply type for Direct Notes") defaultsKey:@"igt_directnotes_avatar_reply"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Direct Notes: GIFs/Stickers reply") subtitle:SCILocalized(@"Forces GIF and sticker reply types for Direct Notes") defaultsKey:@"igt_directnotes_gifs_reply"],
                                                [SCISetting switchCellWithTitle:SCILocalized(@"Direct Notes: Photo reply") subtitle:SCILocalized(@"Forces the photo reply type for Direct Notes") defaultsKey:@"igt_directnotes_photo_reply"],
