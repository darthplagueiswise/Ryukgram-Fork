...
static NSString *const RYGRepoSlug = @"darthplagueiswise/Ryukgram-Fork";
static NSString *const RYGRepoURL = @"https://github.com/darthplagueiswise/Ryukgram-Fork";
static NSString *const RYGRepoIssuesURL = @"https://github.com/darthplagueiswise/Ryukgram-Fork/issues";
static NSString *const RYGRepoReleasesURL = @"https://github.com/darthplagueiswise/Ryukgram-Fork/releases";
static NSString *const RYGRepoTranslateURL = @"https://github.com/darthplagueiswise/Ryukgram-Fork#translating-ryukgram";
