...
extern NSString *const SCI_NOTIF_REPOST;
...
extern NSString *const SCI_NOTIF_READ_RECEIPT;   // someone read a message YOU sent
...
extern NSString *const SCI_NOTIF_GIF_FAVORITE;
...
// ───── Security & Privacy ─────
extern NSString *const SCI_NOTIF_LOCK_SETUP;
extern NSString *const SCI_NOTIF_LOCK_CHANGED;
extern NSString *const SCI_NOTIF_LOCK_RESET;
extern NSString *const SCI_NOTIF_LOCK_FAILED;
extern NSString *const SCI_NOTIF_LOCK_CHAT_TOGGLE;
...
extern NSString *const SCI_NOTIF_BACKUP;             // loading: export / import / restore
