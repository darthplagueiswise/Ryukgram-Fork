...
FOUNDATION_EXPORT void SCINotifyTap(NSString *actionID, NSString *title, NSString * _Nullable subtitle, NSString * _Nullable iconSymbol, SCINotificationTone tone, void (^ _Nullable onTap)(void));
