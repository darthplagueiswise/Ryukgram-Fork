...
+ (NSURL *)shareReadyURL:(NSURL *)fileURL {
	...
	RYGGalleryMediaType mt = RYGGalleryMediaTypeForExtension(fileURL.pathExtension);
	NSURL *dst = [RYGTempFiles claimNamedFile:RYGFileNameForMedia(fileURL, mt, nil) ttl:600 tag:@"share"];
